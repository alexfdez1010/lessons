...
- **Analogy-first.** Open hard concepts with a concrete, everyday analogy before
  the formal definition ("a neuron is basically a tiny, overconfident
  spreadsheet"). One strong analogy beats three paragraphs of abstraction.
